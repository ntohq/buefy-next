...
const GROUP_ID_EXTRACTORS = [
    ...
    regexGroupExtractor(/^(\/src\/data\/[^/]+)\.(?:json|ts)$/),
    regexGroupExtractor(/^(\/src\/pages\/components\/[^/]+)/),
    regexGroupExtractor(/^(\/src\/pages\/extensions\/[^/]+)/),
    regexGroupCoersion(/^\/src\/pages\/installation\/(ConstructorOptions|api\/constructor-options|usage\/constructor-options)/, '/src/pages/installation/ConstructorOptions.vue'),
    regexGroupCoersion(/^\/src\/pages\/installation\/(Customization|usage\/customization)/, '/src/pages/installation/Customization.vue'),
    regexGroupCoersion(/^\/src\/pages\/installation\/(Start|usage\/start)/, '/src/pages/installation/Start.vue'),
    regexGroupExtractor(/^(\/src\/pages\/installation\/[^/]+)/),
    regexGroupExtractor(/^(\/src\/pages\/[^/]+)$/),
    regexGroupExtractor(/^(\/src\/router\/[^/]+)/),
    regexGroupExtractor(/^(\/src\/templates\/[^/]+)/),
